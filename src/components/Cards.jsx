...
const Cards = () => {
  return (
    <div className="w-full h-[70vh] bg-zinc-100 flex gap-5 p-20">
      <div className="cardcontainer h-[50vh] w-1/2">
        <div className=" card relative w-full h-full bg-[#004D43] rounded-lg">
          ...
          <button className="absolute px-5 py-1 border-2 border-[#CDEA68] rounded-full left-10 bottom-10 text-[#CDEA68] text-lg">
            &copy;2019-2023
          </button>
        </div>
      </div>
      <div className="cardcontainer h-[50vh] w-1/2 flex gap-5">
        <div className="card relative flex items-center justify-center w-full h-full bg-[#212121] rounded-lg">
          <img src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg" />
          <button className="absolute px-4 py-1 border-2 border-white rounded-full left-10 bottom-10 text-white text-lg uppercase">
